...
<body>
	<form onsubmit="return check_ok()" name="frm" action="MemberServlet">
		...
		<input type="text" id="id" name="id" value="Members">
		<br><br>
...
<!-- 		<input type="submit" value="CHECK" onclick="return check_ok()"> -->
		...
		<input type="text" name="email" value="JJJ"> @ <input type="text" name="email_dns" value="naver.com">
		...
		<input type="tel" id="ph" name="ph" value="010-0000-0000">
		<br><br>
		...
		<input type="radio" id="chk_mail" name="chk_mail" > 수신
		<input type="radio" id="chk_mail" name="chk_mail" checked> 수신거부
		<br><br>
		
		<label for="interest">관심분야</label>
	      <input type="checkbox" id="interest" name="interest" value="게임"> 게임         
	      <input type="checkbox" id="interest" name="interest" value="도박" checked> 도박         
	      <input type="checkbox" id="interest" name="interest" value="영화"> 영화         
	      <input type="checkbox" id="interest" name="interest" value="프로그래밍" checked> 프로그래밍         
	      <input type="checkbox" id="interest" name="interest" value="코딩" checked> 코딩         
